...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-stone-900 text-stone-900 dark:text-stone-100">
      ...
      {/* Hero */}
      <section className="section bg-gradient-to-b from-white dark:from-stone-900 to-teal-50 dark:to-teal-950">
        <div className="container mx-auto text-center max-w-3xl">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-teal-100 dark:bg-teal-900/30 text-sm text-teal-700 dark:text-teal-300 mb-8 border border-teal-200 dark:border-teal-800">
            <Check className="w-3.5 h-3.5 text-teal-600 dark:text-teal-400" />
            <span>{t.hero.badge}</span>
          </div>

          {/* Headline */}
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-stone-900 dark:text-white mb-6 leading-[1.1]">
            {t.hero.title}
            <br />
          ...
          <div className="mt-16 flex flex-col items-center gap-2">
            ...
            <p className="text-xs text-stone-300 dark:text-stone-600">{t.hero.fromText}</p>
          </div>
        </div>
      </section>

      {/* Features */}
      <section id="features" className="section bg-stone-50 dark:bg-stone-800/50">
      ...
      <section id="pricing" className="section">
        <div className="container-lg mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-5 max-w-2xl mx-auto">
            ...
            {/* Pro */}
            <div className="card p-8 border-teal-200 dark:border-teal-800 relative shadow-teal-100 dark:shadow-teal-900/20">
      ...
      {/* CTA */}
      <section className="section bg-gradient-to-br from-teal-600 dark:from-teal-700 to-teal-700 dark:to-teal-800 text-white dark:text-teal-50">
