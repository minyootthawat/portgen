export const en = {
  ...
  themes: {
    ...
    subtitle: '3 themes ready now. 12+ more coming soon.',
    free: 'Free',
    pro: 'Pro',
    gradientDark: {
      name: 'Gradient Dark',
      desc: 'Bold gradients, modern feel',
    },
    minimalLight: {
      name: 'Minimal Light',
      desc: 'Clean, professional, readable',
    },
    brutalist: {
      name: 'Brutalist',
      desc: 'Bold, raw, distinctive',
    },
  },
  ...
  pricing: {
    ...
    features: {
      ...
      earlyAccess: 'Early access to new themes',
    },
  },
  ...
  login: {
    ...
    continueToDashboard: 'Sign in to continue to your dashboard',
    tryDemo: 'Try Demo Mode',
    tryDemoDesc: 'Explore without an account',
    demoFeatures: {
      portfolios: '3 portfolios',
      portfoliosPre: 'pre-created',
      customThemes: 'Custom themes',
      customThemesUnlock: 'unlocked',
      allFeatures: 'All features',
      allFeaturesAvailable: 'available',
    },
    ...
    developersUsing: 'developers already using',
  },
  ...
  builder: {
    ...
    theme: {
      ...
      subtitle: 'Pick a look that represents you',
    },
    previewStep: {
