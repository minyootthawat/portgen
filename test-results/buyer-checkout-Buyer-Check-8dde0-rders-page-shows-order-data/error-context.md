...
- Name: buyer-checkout.spec.ts >> Buyer Checkout Flow E2E >> step 5: Seller orders page shows order data
- Location: e2e/buyer-checkout.spec.ts:91:7
...
Locator: locator('h1').filter({ hasText: /Orders/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('h1').filter({ hasText: /Orders/i })
